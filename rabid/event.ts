...
/**/          LIMIT 1`);
    ...
    renderEventDetail(event_id: number): Markup {
        ...
        return [h.div, {class: 'container py-3'},
            ...
            // A compact "where clients came from" map of this event's services by
            // postal area (servicemap/), at the very bottom.  NOT live: it carries
            // its own Refresh button rather than recomputing on every service edit.
