...
- **a'lutasit** — guide (by boat) \| fishing guide \| He/she guides by boat  *(also: boats, fishing)*
...
- **gjipa'tlia's** — bishop \| Bishop  *(also: ceremony)*
...
- **malpale'wi'sgw** — woman doctor \| female doctor \| Female doctor  *(also: health)*
- **malpale'wit** — doctor \| Doctor  *(also: health)*
...
- **nepiteget** — healer \| curer \| He/she is a healer  *(also: health)*
...
- **nujialapit** — watchman \| watchman \| Watchman \| He/she is a watchman
...
- **nujielutuet** — imitator \| impersonator \| Imitator
...
- **nujimila'teget** — prankster \| joker \| joker \| prankster \| jester \| jester \| Prankster \| He/she is a prankster  *(also: character)*
...
- **nujinpiteget** — healer \| Healer  *(also: health)*
...
- **nujinutmaqaniget** — storyteller \| tattletale \| gossiper \| Storyteller  *(also: stories-and-writing)*
- **nujipestung** — preacher \| preacher \| Preacher \| He/she is a preacher  *(also: ceremony)*
...
- **nuji'pit** — runner (professional) \| runner (professional) \| errand runner \| errand runner \| Runner \| He/she is a professional runner  *(also: movement)*
...
- **nujisa'se'wamugwa'teget** — magician \| one who changes things \| Magician  *(also: spirit-world)*
...
- **nujiwsiget** — fortuneteller \| fortuneteller \| Fortuneteller \| He/she is a fortuneteller  *(also: spirit-world)*
- **nuse'sgwet** — nurse \| breastfeeder \| breastfeed \| nurser \| wet nurse \| She nurses (child) \| Breastfeeder  *(also: family)*
...
- **pa'tlia's** — priest \| clergy \| Priest  *(also: ceremony)*
- **pa'tlia'si'sgw** — nun \| Nun  *(also: ceremony)*
- **pa'tliatji'j** — brother (religious) \| Brother (religious)  *(also: ceremony)*
