...
Theme: *Land, Water & Sky* — 158 entries (+17 archived)

- **alasenmat** — walk around with light \| use a light \| He/she goes about with a light  *(confidence: m)*
...
- **aqjigateg** — shade \| It is shady  *(confidence: m)*  *(note: shade (light))*
- **eligp'ta'q** — smoke \| smoke drifts toward \| It smokes
- **etligp'ta'q** — smoke \| steam \| It (campfire) is smoking
- **etligp'ta't** — smoking \| steaming \| It (cigar) is smoking
...
- **gaqsusit** — unintentionally burns oneself \| accidentally burns oneself \| He/she unintentionly burns himself/herself  *(also: health)*
- **gaqteg** — burn \| It (meat) is burned
- **gesaseg** — shine \| shines bright \| bright \| It shines  *(note: shine -> fire (light))*
...
- **gesoqsit** — feel the burn badly \| get a bad burn \| get a painful burn \| He/she gets a bad burn  *(also: health)*
- **getmoqsijig** — all burned \| They(trees) are all burned
- **getmoqtegl** — all burned \| They(firewood) are all burned
- **gijitpa'qtug** — in total darkness \| in the dark \| In total darkness  *(confidence: m)*  *(note: darkness)*
...
- **gpugteminu** — Council fire \| Our council fire  *(also: customs)*
...
- **mawgpugtem** — council fire \| Council fire  *(also: customs)*
- **mawigpugtem** — council fire \| Council fire  *(also: customs)*
...
- **pasgesetmat** — light up \| smoke \| He/she lights up  *(also: customs)*
...
- **pasg'sematl** — light up (tobacco pipe) \| light up a cigarette \| He/she lights it (tobacco pipe) up  *(also: customs)*
- **pasg'setmat** — light up (to smoke) \| He/she lights up to smoke  *(also: customs)*
- **pasg'setmuatl** — light up (cigarette or pipe) for \| He/she lights up (a cigarette or pipe) for him/her  *(also: customs)*
...
- **pegn'g** — dark (without light) \| It is dark  *(note: dark)*
...
- **pemigp'ta'q** — puff along \| smoke along \| It is smoking along  *(also: movement)*
- **pemigp'ta't** — smoke along \| puff along \| He/she/it is smoking along
- **pesigte'get** — split wood (kindling) \| He/she splits wood (kindling)  *(also: cutting)*
- **pe's'teg** — burst into flame \| It bursts into a flame
- **petasenmat** — come walking with light or torch \| He/she comes walking with a light or a torch  *(also: movement)*
...
- **pitoqteg** — burn underneath \| set underneath \| penetrate beneath \| It is burning underneath \| It is set underneath  *(also: position)*
...
- **papgestoq** — lights it \| He/she lights it (a pipe)  *(also: customs)*
- **papg'sestoq** — lights it \| He/she lights it.  *(also: customs)*
...
- **papgesestaqan** — wood kindling  *(confidence: l)*
...
- **nu’gwa’luejg** — fireworks \| cattails \| fireworks  *(also: plants)*  *(confidence: m)*  *(note: fireworks/cattails)*
